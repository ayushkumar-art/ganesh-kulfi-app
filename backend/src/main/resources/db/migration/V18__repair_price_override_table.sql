-- V18: Repair price_override table (V17 failed on Render)
-- Drop and recreate with correct structure using retailer_tier

-- Drop existing price_override table if it exists
